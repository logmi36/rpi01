...
cur1 = con1.cursor()
path='/home/pi/Documents/dis/images'
home='/home/pi/Documents/dis'
txtf='/home/pi/Documents/dis/txt'
...
def getId():
    ...
    sql="select ifnull(id,0) as id from pos where ps=1"
    cur1.execute(sql)
    row=cur1.fetchone()
    id=row[0]
    return id
